...
module.exports = class RedemptionMasterUtil {

    /**
         * Utility method to validate the Object
         * @param model RedemptionMasterUtil 
    ...
    static hasError(model, action = MyConst.ValidationModelFor.CREATE) {
        ...
        const error = RedemptionMasterUtil.getJoiVerificationModel(action, model).validate(model);
    ...
    static getJoiVerificationModel(action = MyConst.ValidationModelFor.CREATE, reqBody = null) {
        if (action === MyConst.ValidationModelFor.CREATE) {
            return JOI.object({
                ...
                percentage_value: JOI.number().required(),
                uuid: JOI.string(),
            ...
            return JOI.object(RedemptionMasterUtil.generateDynamicUpdateValidator(reqBody));
        }
    }
